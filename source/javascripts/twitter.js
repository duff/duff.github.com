...
function showTwitterFeed(tweets, twitter_user) {
  ...
  for (var t in tweets) {
    // Temporary app.net hackery.
    content += '<li>'+'<p>'+'<a href="https:/alpha.app.net/duff">'+prettyDate(tweets[t].created_at)+'</a>'+linkifyTweet(tweets[t].text.replace(/\n/g, '<br>'), tweets[t].entities.urls)+'</p>'+'</li>';
    // content += '<li>'+'<p>'+prettyDate(tweets[t].created_at)+linkifyTweet(tweets[t].text.replace(/\n/g, '<br>'), tweets[t].entities.urls)+'</p>'+'</li>';
  }
